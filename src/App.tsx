...
const Ribbon = ({ children, colorClass, className, innerClassName }: { children: React.ReactNode, colorClass: string, className?: string, innerClassName?: string }) => (
  <div className={cn("relative inline-block rounded-2xl shadow-xl transform max-w-full", colorClass, className)}>
    <div className="absolute inset-1 border-2 border-dashed border-white/50 rounded-xl pointer-events-none"></div>
    <div className={cn("relative z-10 px-6 py-3 font-black uppercase tracking-widest text-white drop-shadow-md", innerClassName)}>
      {children}
    </div>
  </div>
);
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#2A1654] bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-[#3B1F75] to-[#1E0F3D] flex flex-col font-sans text-white selection:bg-[#f84c9a]/50 overflow-x-hidden relative">
      ...
      {/* Header */}
      <nav className="flex items-center justify-between px-6 md:px-10 py-2 md:py-3 bg-[#2A1654]/80 backdrop-blur-md border-b-4 border-white/20 fixed top-0 left-0 right-0 w-full z-50 shadow-lg">
        <div className="flex items-center gap-2">
          {/* Logo with bright drop shadow for gel effect */}
          <img src="/logo.svg" alt="El Club de la Diversión" className="h-12 md:h-14 filter drop-shadow-[0_4px_8px_rgba(0,0,0,0.5)] hover:scale-110 hover:-rotate-3 transition-transform origin-left" />
        </div>
        ...
        <a href="#reservas" className="bg-gradient-to-b from-[#fc890d] to-[#d67000] text-white px-6 py-2 rounded-full font-black shadow-[0_8px_16px_rgba(252,137,13,0.4)] hover:shadow-[0_12px_24px_rgba(252,137,13,0.6)] hover:-translate-y-1 border-[3px] border-white transition-all text-sm tracking-widest uppercase relative overflow-hidden group">
      ...
      <main className="flex-1 relative z-10 pt-16 md:pt-20">
        <section className="relative min-h-[calc(100vh-80px)] py-10 flex items-center overflow-hidden">
          ...
          <div className="relative z-10 grid grid-cols-1 gap-8 p-4 md:p-8 max-w-7xl mx-auto items-center w-full">
            <div className="flex flex-col gap-3 lg:gap-4 items-center text-center max-w-5xl mx-auto -mt-10">
              <img 
                src="/logo.svg" 
                alt="El Club de la Diversión" 
                className="w-full max-w-[250px] md:max-w-md h-auto filter drop-shadow-[0_15px_30px_rgba(0,0,0,0.6)] hover:scale-105 transition-transform duration-500 mt-0"
              />
              
              <Ribbon 
                colorClass="bg-[#f84c9a] w-fit -rotate-2" 
                className="animate-bounce"
                innerClassName="md:h-[47px] md:w-[442.68px] text-[14px] leading-[26px] flex items-center justify-center whitespace-normal md:whitespace-nowrap"
              >
                <Sparkles className="w-5 h-5 inline-block mr-1 -mt-1 text-[#fddb20] shrink-0" /> Los mejores recuerdos de la infancia
              </Ribbon>
              
              {/* Puffy-Gel Typography Effect using font-display (Fredoka) */}
              <h1 className="text-3xl md:text-5xl lg:text-[4rem] font-display font-black leading-[1.1] drop-shadow-[0_8px_8px_rgba(0,0,0,0.5)] whitespace-nowrap">
                <span className="text-transparent bg-clip-text bg-gradient-to-b from-white via-white to-gray-300" style={{ filter: 'drop-shadow(0px 4px 0px #42baea)' }}>EMPIEZAN CON UNA</span><br/>
                <span className="text-transparent bg-clip-text bg-gradient-to-b from-[#fddb20] to-[#e5bc00] uppercase inline-block" style={{ filter: 'drop-shadow(0px 6px 0px #fc890d)' }}>GRAN FIESTA</span>
              </h1>
              
              <p className="text-[16px] text-white font-bold max-w-full md:w-[894px] h-auto md:h-[59px] flex items-center justify-center bg-[#1E0F3D]/60 backdrop-blur-md px-4 py-3 md:py-0 rounded-[1.5rem] border-[3px] border-white/30 shadow-xl drop-shadow-md text-center">
                Diversión asegurada para chicos de 1 a 11 años. ¡Ambiente 100% seguro y equipado con las mejores atracciones!
              </p>
              
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-2 lg:mt-4">
                <a href="#reservas" className="bg-gradient-to-b from-[#91cf3b] to-[#7ab52d] text-white px-6 py-2 md:py-2.5 rounded-full font-black shadow-[0_10px_20px_rgba(145,207,59,0.4)] hover:-translate-y-1 border-[3px] border-white transition-all text-sm w-full sm:w-auto text-center uppercase tracking-widest drop-shadow-lg transform hover:scale-105">
                  Reservar Fecha
                </a>
                <a href="#contacto" className="bg-gradient-to-b from-[#42baea] to-[#2b9bc9] text-white px-6 py-2 md:py-2.5 rounded-full font-black shadow-[0_10px_20px_rgba(66,186,234,0.4)] hover:-translate-y-1 border-[3px] border-white transition-all text-sm w-full sm:w-auto text-center uppercase tracking-widest drop-shadow-lg transform hover:scale-105">
                  Contactanos
                </a>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-10">
              ...
              <div className="relative transform -rotate-2 group hover:rotate-0 transition-transform duration-500 flex flex-col">
                <div className="absolute -top-6 -left-6 bg-gradient-to-b from-[#fddb20] to-[#e5bc00] text-[#1E0F3D] w-32 h-32 rounded-full flex flex-col items-center justify-center font-black rotate-12 shadow-2xl border-4 border-white z-20 group-hover:scale-110 transition-transform">
                  ...
                  <span className="text-xs tracking-widest uppercase mb-1 drop-shadow-md">SÚPER</span>
                  <span className="text-3xl font-display leading-none drop-shadow-md">PROMO</span>
                </div>
                ...
                <div className="bg-gradient-to-b from-[#42baea] to-[#2b9bc9] p-10 rounded-[3rem] shadow-[0_20px_40px_rgba(66,186,234,0.3)] border-8 border-white relative overflow-hidden h-full flex flex-col">
                  ...
                  <div className="ml-24 mb-6 relative z-10">
                    <h3 className="text-5xl font-display font-black text-white uppercase leading-none drop-shadow-[0_4px_4px_rgba(0,0,0,0.3)]">¡No pierdas <br/><span className="text-[#fddb20]">Tu fecha!</span></h3>
                  </div>
                  
                  <p className="text-white mb-6 font-bold text-lg leading-relaxed relative z-10">
                    ¡Dale que vuelan! Aprovechá el valor final para tu evento.
                  </p>
                  ...
                  <div className="flex items-center justify-between mt-auto relative z-10">
                    <p className="text-5xl font-display font-black text-white drop-shadow-[0_4px_4px_rgba(0,0,0,0.3)]">$300.000</p>
        ...
        <section id="atracciones" className="py-24 relative overflow-hidden">
          ...
          <div className="max-w-6xl mx-auto px-6 md:px-10 relative z-10">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
              {[
                { icon: <Gift className="w-10 h-10"/>, name: "Pelotero", color: "from-[#42baea] to-[#2b9bc9]" },
                { icon: <div className="w-10 h-10 rounded-full border-4 border-current flex items-center justify-center font-black text-2xl">8</div>, name: "Pool", color: "from-[#91cf3b] to-[#7ab52d]" },
                { icon: <div className="w-10 h-10 border-4 border-current grid place-items-center"><div className="w-4 h-4 bg-current" /></div>, name: "Metegol", color: "from-[#fc890d] to-[#d67000]" },
                { icon: <div className="w-8 h-10 border-x-4 border-b-4 border-current grid grid-rows-3 gap-[2px] p-[2px]"><div className="bg-current"/><div className="bg-current"/><div className="bg-current"/></div>, name: "Jenga", color: "from-[#f84c9a] to-[#d4377d]" },
                { icon: <Music className="w-10 h-10"/>, name: "Just Dance", color: "from-[#8b5cf6] to-[#6d28d9]" },
                { icon: <Star className="w-10 h-10 fill-current"/>, name: "¡Y mucho más!", color: "from-[#fddb20] to-[#dcb700]" },
              ].map((item, i) => (
        ...
        <div className="max-w-6xl mx-auto flex flex-col lg:flex-row justify-between items-center gap-8 xl:gap-12">
          <div className="flex flex-col md:flex-row items-center gap-6 lg:gap-8">
            <div className="flex items-center gap-2 bg-white rounded-[2rem] p-3 shadow-inner shrink-0">
              <img src="/logo.svg" alt="El Club de la Diversión" className="h-14 md:h-16 hover:scale-110 hover:-rotate-3 transition-transform origin-left drop-shadow-md" />
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4">
              <div className="flex items-center gap-3 bg-white/10 pl-6 pr-5 py-3 rounded-full border-2 border-white/20 backdrop-blur-md shadow-lg shrink-0">
                ...
                <span className="font-black text-base tracking-wide drop-shadow-md whitespace-nowrap">221 623 9944</span>
              </div>
              <div className="flex items-center gap-3 bg-white/10 pl-6 pr-5 py-3 rounded-full border-2 border-white/20 backdrop-blur-md shadow-lg shrink-0">
                ...
                <span className="font-black text-[13px] tracking-wide drop-shadow-md whitespace-nowrap">16 N° 1521 entre 63 y 64</span>
              </div>
            </div>
          </div>
